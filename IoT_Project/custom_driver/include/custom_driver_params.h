...
#ifndef CUSTOM_DRIVER_PARAMS_H
#define CUSTOM_DRIVER_PARAMS_H
 ...
 */
static const custom_driver_params_t pulse_counter_params[] =
{
 ...
 */
static const saul_reg_info_t custom_driver_saul_info[] =
{
    CUSTOM_DRIVER_SAUL_INFO
};
